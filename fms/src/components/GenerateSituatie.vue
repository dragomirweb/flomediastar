<template>
<div class="w-100">
    <h3 class="text-center mb-5">Situatie lucrari nr.1/03.10.2018</h3>
    <b-form @submit="onSubmit" @reset="onReset" v-if="show">
        ...
        <b-button type="submit" variant="outline-success">Salveaza</b-button>
        <b-button type="reset" variant="outline-danger">Reseteaza</b-button>
